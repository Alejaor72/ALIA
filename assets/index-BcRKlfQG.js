 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HO(t){t=Qi(t,xt);const e=Qi(t.firestore,Du);return AO(Wf(e),t._key).then(n=>GO(e,t,n))}class $w extends jO{constructor(e){super(),this.firestore=e}convertBytes(e){return new Yi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new xt(this.firestore,null,n)}}function WO(t){t=Qi(t,xu);const e=Qi(t.firestore,Du),n=Wf(e),r=new $w(e);return FO(t._query),SO(n,t._query).then(i=>new zO(e,r,t,i))}function qO(t,e){const n=Qi(t.firestore,Du),r=xw(t),i=BO(t.converter,e);return KO(n,[LO(OO(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,Tn.exists(!1))]).then(()=>r)}function KO(t,e){return function(r,i){const s=new wn;return r.asyncQueue.enqueueAndForget(async()=>hO(await IO(r),i,s)),s.promise}(Wf(t),e)}function GO(t,e,n){const r=n.docs.get(e._key),i=new $w(t);return new zw(t,i,e._key,r,new $s(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){ss=i})(ei),$r(new hr("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Du(new WN(r.getProvider("auth-internal")),new QN(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new W(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new No(h.options.projectId,f)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Xt(Yg,"4.6.3",e),Xt(Yg,"4.6.3","esm2017")})();const Qf=_0(gC),QO=Ck(Qf),YO=FN(Qf),Yf=kO(Qf),XO=async(t,e)=>{try{const r=(await fP(QO,t,e)).user;return console.log(r.uid),!0}catch(n){return console.error(n.code,n.message),!1}},JO=async(t,e)=>{try{const n=UN(YO,`${e}/${t.name}`);return await MN(n,t),await bN(n)}catch(n){console.error("Upload error",n)}},ZO=async t=>{try{const e=await qO(Nw(Yf,"projects"),t);console.log("The project was successfully updated",e.id)}catch(e){console.log("Error adding a project",e)}},e2=async()=>{try{const t=await WO(Nw(Yf,"projects")),e=[];return t.forEach(n=>{e.push({id:n.id,...n.data()})}),e}catch(t){return console.error("Error getting projects:",t),[]}},t2=async t=>{try{const e=xw(Yf,"projects",t),n=await HO(e);if(n.exists())return{id:n.id,...n.data()};throw new Error("No such document!")}catch(e){throw console.error("Error getting document:",e),e}};function Hw({onChange:t}){const e=n=>{const r=n.target.value;console.log("Selected value in filter:",r),t(r)};return S.jsx("section",{className:"filters-section",children:S.jsxs("select",{onChange:e,children:[S.jsx("option",{value:"",children:"Tipo de proyecto"}),S.jsx("option",{value:"Todos",children:"Todos"}),S.jsx("option",{value:"UX",children:"UX"}),S.jsx("option",{value:"UI",children:"UI"}),S.jsx("option",{value:"Ilustración",children:"Ilustración"}),S.jsx("option",{value:"Animación",children:"Animación"}),S.jsx("option",{value:"Programación",children:"Programación"})]})})}Hw.propTypes={onChange:dt.func.isRequired};function Ww({id:t,imgUrl:e,mainText:n,integrantes:r}){const i=Jr(),s=()=>{i(`/details/${t}`)};return S.jsxs("div",{className:"proyectCard",onClick:s,children:[S.jsx("img",{src:e,alt:"Project"}),S.jsxs("div",{className:"proyectText",children:[S.jsx("h2",{className:"description",children:n}),S.jsx("p",{className:"names",children:r})]})]})}Ww.propTypes={id:dt.string.isRequired,imgUrl:dt.string.isRequired,mainText:dt.string.isRequired,integrantes:dt.string.isRequired};function n2(){const[t,e]=B.useState([]),[n,r]=B.useState([]),i=Jr();B.useEffect(()=>{(async()=>{try{const u=await e2();e(u),r(u),console.log("Projects from Firestore:",u)}catch(u){console.error("Error loading projects from Firestore:",u)}})()},[]);const s=l=>{console.log("Selected value:",l);try{if(l===""||l==="Todos")r(t);else{const u=t.filter(h=>h.especializacion===l);console.log("Filtered projects:",u),r(u)}}catch(u){console.error("Error filtering projects:",u)}},o=()=>{i("/upload")};return S.jsxs("div",{children:[S.jsx(ts,{}),S.jsx(ns,{}),S.jsxs("div",{className:"sec1",children:[S.jsx("h2",{children:"Nuestros Proyectos"}),S.jsxs("div",{className:"filters",children:[S.jsx(Hw,{onChange:s}),S.jsx(Zr,{label:"+",className:"addBtn",onClick:o})]})]}),S.jsx("div",{className:"proyectsSec",children:n.length>0?n.map(l=>S.jsx(Ww,{id:l.id,imgUrl:l.imgUrl,mainText:"Designers",integrantes:l.integrantes||"No Integrantes"},l.id)):S.jsx("p",{children:"No hay proyectos disponibles."})}),S.jsx(a0,{})]})}function r2(){const t=Jr(),[e,n]=B.useState(""),[r,i]=B.useState(""),[s,o]=B.useState(""),l=async u=>{u.preventDefault(),await XO(e,r)?(t("/upload"),console.log("User logged")):(o("Login failed"),console.log("Login Failed"))};return S.jsx("form",{onSubmit:l,children:S.jsxs("div",{className:"inputLoginDiv",children:[S.jsx("h3",{className:"subtitleLogin",children:"Iniciar Sesión"}),s&&S.jsx("p",{className:"error-message",children:s}),S.jsxs("div",{className:"inputsLog",children:[S.jsx("input",{type:"text",placeholder:"Email",className:"inputLogin",value:e,onChange:u=>n(u.target.value)}),S.jsx("input",{type:"password",placeholder:"Contraseña",className:"inputLogin",value:r,onChange:u=>i(u.target.value)})]}),S.jsx(Zr,{label:"Iniciar Sesión",type:"submit",onClick:()=>{}})]})})}function i2(){const t=()=>{};return S.jsxs(S.Fragment,{children:[S.jsx(ts,{}),S.jsx(ns,{}),S.jsxs("div",{className:"loginDiv",children:[S.jsx("h1",{className:"loginAlia",children:"ALIA"}),S.jsx(r2,{onSubmit:t})]})]})}const Ny={imageUpload:null,projectName:"",behanceLink:"",integrantes:"",especializacion:"",descripcion:""};function qw({onSubmit:t}){const[e,n]=B.useState(Ny),[r,i]=B.useState(null),s=l=>{const{name:u,value:h,files:f}=l.target;if(u==="imageUpload"&&f&&f[0]){n({...e,[u]:f[0]});const p=new FileReader;p.onload=()=>{i(p.result)},p.readAsDataURL(f[0])}else n({...e,[u]:h})},o=async l=>{l.preventDefault();try{let u="";e.imageUpload&&(u=await JO(e.imageUpload,e.projectName));const h={name:e.projectName,behanceLink:e.behanceLink,integrantes:e.integrantes,especializacion:e.especializacion,descripcion:e.descripcion,imgUrl:u};await ZO(h),t(),n(Ny),i(null)}catch(u){console.error("Error uploading project:",u)}};return S.jsx("form",{onSubmit:o,children:S.jsxs("div",{className:"inputDivProject",children:[S.jsxs("div",{className:"upload-container",children:[S.jsx("input",{type:"file",name:"imageUpload",onChange:s}),r&&S.jsx("img",{src:r,alt:"Preview",style:{maxWidth:"100%",maxHeight:"200px",marginTop:"10px"}})]}),S.jsxs("div",{className:"textPart",children:[S.jsx("input",{type:"text",name:"projectName",placeholder:"Nombre del Proyecto",value:e.projectName,onChange:s,className:"inputProject",required:!0}),S.jsx("input",{type:"text",name:"behanceLink",placeholder:"Link de Behance",value:e.behanceLink,onChange:s,className:"inputProject",required:!0}),S.jsxs("select",{className:"DesignselectProject",name:"integrantes",value:e.integrantes,onChange:s,required:!0,children:[S.jsx("option",{value:"",children:"Integrantes"}),S.jsx("option",{value:"Laura",children:"Laura"}),S.jsx("option",{value:"Isabella",children:"Isabella"}),S.jsx("option",{value:"Andrea",children:"Andrea"}),S.jsx("option",{value:"Alejandra",children:"Alejandra"})]}),S.jsxs("select",{className:"DesignselectProject",name:"especializacion",value:e.especializacion,onChange:s,required:!0,children:[S.jsx("option",{value:"",children:"Especialización"}),S.jsx("option",{value:"UX",children:"UX"}),S.jsx("option",{value:"UI",children:"UI"}),S.jsx("option",{value:"Ilustración",children:"Ilustración"}),S.jsx("option",{value:"Animación",children:"Animación"}),S.jsx("option",{value:"Programación",children:"Programación"})]}),S.jsx("input",{type:"text",name:"descripcion",placeholder:"Descripción",value:e.descripcion,onChange:s,className:"inputCommentProject",required:!0}),S.jsx(Zr,{type:"submit",label:"Publicar"})]})]})})}qw.propTypes={onSubmit:dt.func.isRequired};function s2(){const[t,e]=B.useState(""),n=()=>{e("Project uploaded successfully!")};return S.jsxs(S.Fragment,{children:[S.jsx(ts,{}),S.jsx(ns,{}),S.jsxs("div",{className:"ProjectDiv",children:[t&&S.jsx("p",{children:t}),S.jsx(qw,{onSubmit:n})]})]})}const o2="/assets/ArrowButton-BRbhYQ7t.png",a2="/assets/uxTag-D-5qmE45.png",l2="/assets/uiTag-BIybO8ZJ.png",u2="/assets/AnimeTags-BIcVN1UI.png",c2="/assets/IlustraTags-Cc9nl8Qn.png",h2="/assets/prograTag-CXHQ0xU0.png",d2="/assets/BehanceIcon-ndwzoHJz.png";function f2(){const{projectId:t}=CS(),[e,n]=B.useState(null),r=Jr();B.useEffect(()=>{(async()=>{try{const l=await t2(t);n(l)}catch(l){console.error("Error fetching project details:",l)}})()},[t]);const i=()=>{r("/projects")},s=o=>{switch(o){case"UX":return a2;case"UI":return l2;case"Programación":return h2;case"Animación":return u2;case"Ilustración":return c2;default:return null}};return S.jsxs("div",{children:[S.jsx(ts,{}),S.jsx(ns,{}),S.jsx("div",{className:"infoarrow",children:S.jsx("button",{onClick:i,className:"ArrowButton",children:S.jsx("img",{src:o2,alt:"Arrow Button"})})}),S.jsx("div",{className:"infoContainer",children:e?S.jsxs(S.Fragment,{children:[S.jsx("img",{src:e.imgUrl,className:"subwayProject",alt:"Project"}),S.jsx("h2",{className:"detailsTitle",children:e.name}),S.jsxs("div",{className:"namesContainer",children:[S.jsx("p",{className:"namesDesing",children:e.integrantes}),S.jsx("p",{className:"context",children:e.descripcion})]}),S.jsx("div",{className:"Tags",children:e.especializacion&&S.jsx("img",{src:s(e.especializacion),alt:e.especializacion,className:"tag"})}),S.jsxs("div",{className:"urlContainer",children:[S.jsx("img",{src:d2,className:"BehanceIcon",alt:"BehanceIcon"}),S.jsx("a",{href:e.behanceLink,target:"_blank",rel:"noopener noreferrer",children:"Ver proyecto"})]})]}):S.jsx("p",{children:"Cargando detalles del proyecto..."})})]})}function p2(){return S.jsxs(zS,{children:[S.jsx(Mn,{path:"/",element:S.jsx(U1,{})}),S.jsx(Mn,{path:"/projects",element:S.jsx(n2,{})}),S.jsx(Mn,{path:"/contact",element:S.jsx(c1,{})}),S.jsx(Mn,{path:"/login",element:S.jsx(i2,{})}),S.jsx(Mn,{path:"/upload",element:S.jsx(s2,{})}),S.jsx(Mn,{path:"/details/:projectId",element:S.jsx(f2,{})}),S.jsx(Mn,{path:"/*",element:S.jsx("h1",{children:"404"})})]})}function m2(){const t=jo();return console.log(t),S.jsx(p2,{})}const Kw=document.getElementById("root"),g2=$v(Kw);g2.render(S.jsx(QS,{children:S.jsx(m2,{})}));console.log(Kw);
